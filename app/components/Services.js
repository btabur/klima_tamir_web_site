...
const Services = () => {
  return (
    <div className="flex flex-wrap items-center justify-center p-10 gap-8">
      <div className="flex flex-col items-center justify-center ">
        <h2 className="text-4xl">HİZMETLERİMİZ</h2>
        <hr className="w-full" />
      </div>

      <div className="grid grid-cols-3  items-start justify-center gap-8">
